...
abstract class $FailureResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'code_transaction') String codeTransaction});
}
...
class _$FailureResponseImpl implements _FailureResponse {
  ...
  @override
  String toString() {
    return 'FailureResponse(codeTransaction: $codeTransaction)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, codeTransaction);
...
abstract class _FailureResponse implements FailureResponse {
  factory _FailureResponse(
      {@JsonKey(name: 'code_transaction')
      required final String codeTransaction}) = _$FailureResponseImpl;
