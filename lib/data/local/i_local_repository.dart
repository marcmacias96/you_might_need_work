...
/// An abstract repository interface for local data storage operations related to authentication.
///
/// This interface defines methods for caching and retrieving authentication-related data
...
/// interface is used to perform local data storage operations related to authentication.
/// This interface can be used as a contract to define methods for caching, retrieving,
/// and removing authentication-related data locally on the device.
abstract class ILocalRepository {
  /// Cache authentication data locally on the device.
  ///
  /// This method stores the provided [authToken] locally on the device, allowing it to be
  /// retrieved later. It is typically used for caching authentication-related data.
  Future<void> cacheAuthData(AuthToken authToken);

  /// Retrieve the cached authentication data from local storage.
  ///
  /// This method retrieves the cached authentication data, typically user authentication
  /// tokens, that was previously cached locally on the device. If no data is cached,
  /// it returns `null`.
  AuthToken? getAuthData();

  /// Remove the cached authentication data from local storage.
  ///
  /// This method removes any previously cached authentication data from local storage on
